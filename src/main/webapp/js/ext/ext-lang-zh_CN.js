...
/**
 * 配置grid的可以选择
 * html引入js时按ext-base.js ext-all-debug.js ext-lang-zh_CN.js的顺序引入
 */
Ext.grid.GridView.prototype.cellTpl = new Ext.Template(
	Ext.grid.GridView.prototype.cellTpl.html.replace('unselectable="on"','').replace('class="','class="x-selectable ')
);
